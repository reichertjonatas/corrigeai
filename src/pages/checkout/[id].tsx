...
function CheckoutPage({ planoDados }: any) {
        ...
        if (data) {
          if (modoAssinatura) {
            const response = await API.post(
              "/pagamento/checkout/capturarPagamento",
              { modoAssinatura, planoIdDb: planoDados.id, ...data }
            );
  ...
  const [plano, setPlano] = React.useState<ICheckoutPlano>({
    loaded: false,
    data: null,
  });
    ...
    <div>
      ...
      <div className="checkout">
        <div className="box">
          ...
          <h1>Checkout</h1>
          {isLoading && <PreLoader />}
          {isLoaded && <>Aguardando pagamento do boleto!</>}
                ...
                <div className="head">
                  <div className="box_list">
                    ...
                    <span className="regular">
                      {planoDados.textoMes} de acesso à Plataforma Corrige Aí
                    </span>
                  </div>
                  <div className="box_list">
                    <span className="bold">
                      ...
                      {new Intl.NumberFormat("pt-BR", {
                        style: "currency",
                        currency: "BRL",
                      }).format(planoDados.precoPagarme / 100)}
                    </span>
                    <span className="regular">
                      Em até {planoDados.parcelamentoTexto} no cartão de crédito
                    </span>
                  </div>
                </div>
              ...
              >
                <span className="check" style={{ maxWidth: "60%" }}>
                  ...
                  >
                    ...
                    <a
                      rel="noreferrer"
                      href="https://api.corrigeai.com/uploads/TERMOS_DE_USO_b85a523cbe.pdf"
                      target="_blank"
                    >
                      Termos de Uso
                    </a>{" "}
                    ...
                    <a
                      rel="noreferrer"
                      href="https://api.corrigeai.com/uploads/POLITICA_DE_PRIVACIDADE_7ff66367ba.pdf"
                      target="_blank"
                    >
      ...
      <style jsx>
        {`
          ...
          .checkout .box .caixa h2:first-child {
            display: block;
            width: 100%;
            font-size: 1.3rem;
            margin: 0 0 1.5rem;
          }
          .checkout .box .caixa h2 {
            display: block;
            width: 100%;
            font-size: 1.3rem;
            margin: 1.5rem 0;
          ...
          .checkout .box .caixa .head {
            display: grid;
            grid-template-columns: 1fr 1fr;
            gap: 0.5rem;
          }
          .checkout .box .caixa .head .box_list {
            display: flex;
            flex-direction: column;
          }
          .checkout .box .caixa .head .box_list .bold {
            display: block;
            width: 100%;
            font-weight: 500;
            color: var(--dark);
          ...
          .checkout .box .caixa .head .box_list .regular {
            display: block;
            width: 100%;
            font-weight: 400;
            color: #929292;
          ...
          .checkout .box .caixa .form {
            display: block;
            width: 100%;
          }
          .checkout .box .caixa .form .grid {
            display: grid;
            grid-template-columns: 1fr 1fr;
            gap: 1rem;
          }
          .checkout .box .caixa .form .grid .input {
            display: flex;
            flex-direction: column;
            width: 100%;
          }
          .checkout .box .caixa .form .grid .input input {
            margin: 0;
          }
          .checkout .box .caixa .form label {
            display: block;
            width: 100%;
            color: #495057;
          }
          .checkout .box .caixa .form input {
            display: block;
            width: 100%;
          ...
          .checkout .box .caixa .form select {
            display: block;
            width: 100%;
