      ...
      <style global jsx>
        {`
          ...
          header.desktop {
            ...
            text-align: center;
            z-index: 999;
            background: rgb(114, 176, 29);
            background: linear-gradient(
              90deg,
              rgba(114, 176, 29, 1) 0%,
              rgba(114, 176, 29, 1) 0%,
              rgba(132, 204, 34, 1) 100%
            );
          }
          .toogle {
            display: none;
          ...
          .passo3 .borda {
            ...
            border-top: 5px solid #84ca22;
            border-left: 5px solid #84ca22;
            border-right: 5px solid #84ca22;
            height: 12.5rem;
            max-width: 80%;
            margin-left: -40%;
          }
