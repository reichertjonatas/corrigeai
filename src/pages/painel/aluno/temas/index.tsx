...
function Temas({ session, temasProps }: any) {
  ...
  return (
    <MainLayout>
        ...
        <div className="content">
          <div className="head-box">
            <a
              ...
              onClick={() => setCategoria("enem", session.jwt)}
            >
              <span className="icon">
            ...
            <a
              ...
              onClick={() => setCategoria("corrigeai", session.jwt)}
            >
              <span className="icon">
          ...
          <div className="box-tema">
            ...
            {currentTema != null && (
              <div
                className="conteudo"
                dangerouslySetInnerHTML={{ __html: currentTema.content }}
              ></div>
            )}{" "}
          </div>
        ...
        <div className="lista-temas">
          {isLoading ? (
            ...
            <ul>
              ...
              {temas != null &&
                temas.length > 0 &&
                temas.map((temaRow: any, index: number) => {
                  return (
                    <li style={{ cursor: "pointer" }} key={index}>
                      <a
                        className={
                          currentTema != null
                            ? temaRow.id == currentTema.id
                              ? "activeTema"
                              : ""
                            : ""
                        }
                        onClick={() => setCurrentTema(temaRow)}
                      >
                        {temaRow.titulo}{" "}
                      </a>
                    </li>
      ...
      <style global jsx>{`
        .grid-temas .content .box-tema .conteudo p {
          margin: auto !important;
        }
        .grid-temas .content .box-tema .conteudo img {
          max-width: 100% !important;
        }
        .grid-temas .content .box-tema .conteudo ul {
