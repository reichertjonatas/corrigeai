        ...
        <div className="sidebar-panel">
          <div className="grades">
            <ul>
              ...
              <li>Sua média geral: {mediaGeral(redacoes.filter(redacao => redacao.status_correcao === 'finalizada')) == 0 || mediaGeral(redacoes.filter(redacao => redacao.status_correcao === 'finalizada')) == undefined ? '---' : mediaGeral(redacoes.filter(redacao => redacao.status_correcao === 'finalizada'))} </li>
